    ...
    <div className="min-h-screen bg-moonWhite">
      <header className="sticky top-0 z-10 border-b border-warmGray-100 bg-moonWhite/80 backdrop-blur-sm">
        <div className="mx-auto flex max-w-2xl items-center gap-3 px-4 py-4">
          ...
          <h1 className="font-display text-lg font-bold text-warmGray-800">纪念日</h1>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
        ...
        >
          ...
          <h2 className="mb-2 text-lg font-semibold text-warmGray-700">还没有纪念日</h2>
          <p className="mb-6 text-sm text-warmGray-400">
            添加你们的第一个纪念日，让每个特别的日子都不被遗忘
          </p>
          <button className="btn-primary">添加纪念日</button>
        </motion.div>
      </main>
    </div>
  );
